        ...
        <ul>
            ...
            <li><a style="font-family:cursive;" href="feedback.php">FEEDBACK</a></li>
             ...
             <?php
                    ...
                    <?php } else { ?>
                        <li><a style="font-family: cursive;" href="admin_login.php">LOGIN</a></li>
...
<div class="cont">
    <h3 style="font-family:cursive; text-align: center;font-size: 30px;">Update Fine Status to Paid</h3><br><br><br><br>

    <div class="backbox" style="background-color: white; padding: 20px; border-radius: 8px;width: 350px;margin-left: 750px;position: relative;height: 170px;">
        <form method="post" action="" style="max-width: 400px; margin: 0 auto;">

            <div style="margin-bottom: 15px; text-align: left;">
                <label for="username" style="display: inline-block; width: 80px; text-align: left;font-family: cursive;">Username:</label>
                <input type="text" name="username" id="username" required="" style="width: 200%; max-width: 250px;">
            </div>

            <div style="margin-bottom: 15px; text-align: left;">
                <label for="bookid" style="display: inline-block; width: 80px; text-align: left;font-family: cursive;">Book ID:</label>
                <input type="text" name="bookid" id="bookid" required="" style="width: 200%; max-width: 250px;">
            </div>

            <button type="submit" name="update_status" style="background-color: #36bb36; color: #333; padding: 10px 20px; display: block; margin: 0 auto; border: none; border-radius: 4px;width: 150px;">
                Update Status
            </button>
        </form>
    </div>
 ...
 <a href="up_fine.php"><i class="fas fa-dollar-sign"></i><span>Update Fine</span></a>
    ...
    <?php } else { ?>
        <a href="student_login.php"><i class="fas fa-sign-in-alt"></i><span> Login</span></a>
...
<h2 style="font-family:cursive;font-size: 25px;margin-left: 110px;"><strong>UPDATE FINE</strong></h2>

        ...
        <header>
            ...
            <nav>
                <ul>
                    ...
                    if (isset($_SESSION['login_user'])) { ?>
                        <li><a style="font-family:cursive;word-spacing: 4px" href="student.php">STUDENT INFORMATION</a></li>
    ...
    <!-- Your existing content goes here -->
        ...
        <div class="comment">
            ...
            <form action="" method="post">
                ...
                <input class="btn" type="submit" name="submit" value="Comment"><br>
            </form>
            ...
            while ($row = mysqli_fetch_assoc($res)) {
                ...
                echo "<div class='feedback-item'><strong>Username:{admin}@</strong> " . $row['username'] . "</div>";

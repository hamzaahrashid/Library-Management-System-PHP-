...
<button name="submit2" type="submit" class="btn btn-default" style="height: 28px;border-radius:7px ;background-color:green;width: 200px;color: white; ">RETURNED</button>&nbsp&nbsp
<button name="submit3" type="submit" class="btn btn-default" style="height: 28px;border-radius:7px;background-color:red ;width: 200px;color: white;">EXPIRED</button>
 ...
 <div class="srch" style="margin-top:10px;float:right;">

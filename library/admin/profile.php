...
$q = mysqli_query($db, "SELECT a.username,a.password, a.email, ad.first, ad.last, ad.contact 
                        FROM admin a 
                        INNER JOIN admin_details ad ON a.admin_id = ad.admin_id 
                        WHERE a.username = '" . mysqli_real_escape_string($db, $_SESSION['login_user']) . "';");
            ...
            <?php
         echo "<table class='table table-bordered' style='border: 1px white; border-collapse: collapse; width: 100%; text-align: left; color:white;font-family:cursive'>";
